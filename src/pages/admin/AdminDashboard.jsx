...
const AdminDashboard = () => {
  ...
  const quickActions = [
    ...
    { icon: Settings,      label: "Settings",     color: "#0ea5e9", bg: "#f0f9ff", path: "/admin/settings/role-permissions"  },
  ]
            ...
            <div>
              ...
              <h1 className="text-white font-black tracking-tight leading-tight" style={{ fontSize: "clamp(1.4rem,3vw,2rem)" }}>
                {statsLoading
                  ...
                  : <>Welcome back, <span className="text-yellow-300">{profile.name || "Admin"}</span>{" "}<span className="text-white/50 font-medium text-base"> School Admin</span></>
                }
              </h1>
