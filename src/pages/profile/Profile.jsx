          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-6 mb-6 transform transition-all hover:shadow-2xl">
              <div className="text-center">
                ...
                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-green-50 text-green-700 rounded-full text-sm font-medium">
            ...
            <div className="mt-6 bg-white rounded-2xl shadow-xl border border-gray-100 p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Institute Contact Person</p>
                </div>
              </div>
              <p className="font-medium text-gray-900 text-lg">{profile?.name || 'Admin Name'}</p>
              <p className="text-sm text-gray-500 mt-1">{profile?.role || 'School Administrator'}</p>
            </div>
          </div>
