...
const AddStudent = () => {
  ...
  /* ========================= 
     Fetch Classes on Mount - Do NOT Modify
  ========================= */
  ...
  /* ========================= 
     Fetch Sections when class_id changes - Do NOT Modify
  ========================= */
      ...
      {showSuccess && (
        <div className="fixed top-6 right-6 bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-4 rounded-xl shadow-2xl flex items-center gap-3 z-50 animate-slide-in-right">
          ...
          <div>
            ...
            <p className="text-sm text-green-50">Student added successfully</p>
          </div>
        </div>
      )}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">Enroll New Student</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-1">Enroll New Student</h1>
              <p className="text-gray-600">Fill in the student information to add a new record</p>
            </div>
          </div>
        </div>
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              {[
                ...
                { label: "Father's Photo", name: 'father_photo', accept: 'image/*', icon: User },
                { label: "Mother's Photo", name: 'mother_photo', accept: 'image/*', icon: User },
              ].map((file) => (
