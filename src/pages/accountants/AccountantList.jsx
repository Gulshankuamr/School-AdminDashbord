    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium text-lg">Loading accountants...</p>
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-gray-500 mt-1">Manage all accountant records</p>
              </div>
            ...
            <div className="mt-6 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
              />
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            {loading && accountants.length > 0 && (
              <div className="px-6 py-3 bg-purple-50 border-b border-purple-100 flex items-center gap-2">
                ...
                <span className="text-sm text-purple-600 font-medium">Refreshing...</span>
              </div>
            )}
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[1000px]">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Accountant</th>
                      ...
                      <tr key={accountant.accountant_id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-400">{accountant.user_email || 'No email'}</p>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-600">{accountant.user_email || '—'}</span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {accountant.mobile_number ? (
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="text-sm font-medium text-gray-700">{accountant.mobile_number}</span>
                            </div>
                          ) : (
                            <span className="text-sm text-gray-400">—</span>
                          )}
            ...
            {filteredAccountants.length > 0 && (
              <div className="px-6 py-4 flex flex-col sm:flex-row items-center justify-between border-t border-gray-100 bg-gray-50/50">
                <p className="text-sm text-gray-500">
                  Showing <span className="font-medium text-gray-700">{filteredAccountants.length}</span> of{' '}
                  <span className="font-medium text-gray-700">{totalAccountants}</span> accountants
                </p>
                {totalPages > 1 && (
                  <div className="flex gap-2 mt-3 sm:mt-0">
                    <button
                      ...
                      className="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed transition flex items-center gap-1 text-sm font-medium">
